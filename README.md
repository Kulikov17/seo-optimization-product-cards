...
Полезные ссылки https://habr.com/ru/companies/slurm/articles/741670/

Как запустить:

Убедитесь, что Prometheus извлекает метрики из вашего приложения, посетив http://localhost:9090/targets в веб-браузере. Целевые приложения должны быть указаны в состоянии «UP». Когда запущен Prometheus, можно создать дашборд в Grafana для визуализации метрик из нашего приложения. После запуска Grafana перейдите по адресу: localhost:3000. Вы должны увидеть экран авторизации. Введите имя пользователя и пароль по умолчанию (admin/admin) и нажмите «Войти». Вам должно быть предложено изменить пароль. Введите новый пароль и нажмите «Сохранить». 

Далее нажмите на кнопку «Создать свой первый источник данных» и выберете Prometheus.  Введите следующую информацию:
- URL: http://prometheus:9090
- HTTP Method: GET
Нажмите на кнопку Save & Test и переходите создавать дашборд.

Дашборд можно загрузить из папки grafana/dashboards.
